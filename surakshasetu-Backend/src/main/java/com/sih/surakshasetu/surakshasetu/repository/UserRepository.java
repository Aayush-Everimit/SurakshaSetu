...
public interface UserRepository extends JpaRepository<User, Long > {
    ...
    @Query("select new com.sih.surakshasetu.surakshasetu.dto.UserDTO(q.userid, q.username, q.password, q.email, q.location, q.registeredAt, q.lastActiveAt) from User q")
